...
output "bootstrap_brokers" {
  ...
  value = compact([
    try(aws_msk_cluster.main[0].bootstrap_brokers, ""),
    try(aws_msk_cluster.main[0].bootstrap_brokers_sasl_iam, ""),
    try(aws_msk_cluster.main[0].bootstrap_brokers_sasl_scram, ""),
...
output "bootstrap_brokers_sasl_iam" {
  description = "One or more DNS names (or IP addresses) and SASL IAM port pairs. main attribute will have a value if `encryption_in_transit_client_broker` is set to `TLS_PLAINTEXT` or `TLS` and `client_authentication_sasl_iam` is set to `true`"
  value       = try(aws_msk_cluster.main[0].bootstrap_brokers_sasl_iam, "")
}

output "bootstrap_brokers_sasl_scram" {
  description = "One or more DNS names (or IP addresses) and SASL SCRAM port pairs. main attribute will have a value if `encryption_in_transit_client_broker` is set to `TLS_PLAINTEXT` or `TLS` and `client_authentication_sasl_scram` is set to `true`"
  value       = try(aws_msk_cluster.main[0].bootstrap_brokers_sasl_scram, "")
}

output "bootstrap_brokers_tls" {
  description = "One or more DNS names (or IP addresses) and TLS port pairs. main attribute will have a value if `encryption_in_transit_client_broker` is set to `TLS_PLAINTEXT` or `TLS`"
...
output "current_version" {
  ...
  value       = try(aws_msk_cluster.main[0].current_version, "")
}
...
output "zookeeper_connect_string_tls" {
  ...
  value       = try(aws_msk_cluster.main[0].zookeeper_connect_string_tls, "")
}
...
output "configuration_arn" {
  ...
  value       = try(aws_msk_configuration.main[0].arn, "")
}

output "configuration_latest_revision" {
  description = "Latest revision of the configuration"
  value       = try(aws_msk_configuration.main[0].latest_revision, "")
}
...
output "scram_secret_association_id" {
  description = "Amazon Resource Name (ARN) of the MSK cluster"
  value       = try(aws_msk_scram_secret_association.main[0].id, "")
}
...
output "log_group_arn" {
  ...
  value       = try(aws_cloudwatch_log_group.main[0].arn, "")
}
...
output "appautoscaling_policy_arn" {
  ...
  value       = try(aws_appautoscaling_policy.main[0].arn, "")
}

output "appautoscaling_policy_name" {
  description = "The scaling policy's name"
  value       = try(aws_appautoscaling_policy.main[0].name, "")
}

output "appautoscaling_policy_policy_type" {
  description = "The scaling policy's type"
  value       = try(aws_appautoscaling_policy.main[0].policy_type, "")
}
...
output "connect_custom_plugins" {
  ...
  value       = aws_mskconnect_custom_plugin.main
}
...
output "connect_worker_configuration_arn" {
  ...
  value       = try(aws_mskconnect_worker_configuration.main[0].arn, "")
}
...
output "connect_worker_configuration_latest_revision" {
  ...
  value       = try(aws_mskconnect_worker_configuration.main[0].latest_revision, "")
}
